...
1. **What does the oil formation volume factor ($$B_o$$) represent?**  
  <br/> a) The volume of gas at reservoir conditions.  
  <br/> b) The ratio of oil volume at reservoir conditions to surface conditions.  
  <br/> c) The compressibility of water in the reservoir.  
  <br/> **Answer**: b) The ratio of oil volume at reservoir conditions to surface conditions.

2. **Why is $$B_g$$ important for pipeline design?**  
  <br/> a) It predicts how much gas expands from reservoir to surface.  
  <br/> b) It calculates the reservoir’s porosity.  
  <br/> c) It determines the water cut in production.  
  <br/> **Answer**: a) It predicts how much gas expands from reservoir to surface.

3. **How does $$B_o$$ typically differ between light and heavy crudes?**  
  <br/> a) Light crudes have a lower $$B_o$$ than heavy crudes.  
  <br/> b) Light crudes have a higher $$B_o$$ due to more dissolved gas.  
  <br/> c) Both have the same $$B_o$$ regardless of crude type.  
  <br/> **Answer**: b) Light crudes have a higher $$B_o$$ due to more dissolved gas.
