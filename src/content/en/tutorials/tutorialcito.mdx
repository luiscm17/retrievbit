---
title: "Introduction to Data Science with Python, with focus on the oil industry"
...
Lore this is a `code` ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quod..

#### SQL

```python title="saludar.py"
...
if __name__ == "__main__":
    ...
    print(mensaje)  # Imprime: ¡Hola, Usuario! Bienvenido a Python.
    
    # Ejemplo con una lista

    numeros = [1, 2, 3, 4, 5]
    cuadrados = [n**2 for n in numeros]  # List comprehension
    print(f"Cuadrados: {cuadrados}")  # Imprime: Cuadrados: [1, 4, 9, 16, 25]
```
---
...
<Youtube client:load id="XYsk4ibhd5g" title="Witcher IV Gameplay Trailer" lang="es" />
